 ...
 */
package com.jelly.music.player.LauncherActivity;
...
import com.jelly.music.player.MainActivity.MainActivity;
import com.jelly.music.player.MiscFragments.TrialFragment;
import com.jelly.music.player.Services.BuildMusicLibraryService;
import com.jelly.music.player.Utils.Common;
import com.jelly.music.player.WelcomeActivity.WelcomeActivity;
...
public class LauncherActivity extends FragmentActivity {
    ...
    protected static final String ITEM_SKU = "com.jelly.music.player.unlock";
    protected static final String ITEM_SKU_PROMO = "com.jelly.music.player.unlock.promo";
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        Parse.initialize(this,"aZiGV1G02m1Mj3SaaD9riuyrucDclK7abpc2Ibz3", "eCPoMrWrFnnHPVmBbDDIAFAMTA5EJLgtHLS2U9St");
...
// Send the dimensions to Parse along with the 'read' event
	...
	private boolean checkTrialReactivationTime() {
		...
		File file = new File(Environment.getExternalStorageDirectory() + "/.jelly_info");
		if (file.exists()) {
