 ...
 */
package com.jelly.music.player.AsyncTasks;
...
import com.jelly.music.player.FoldersFragment.FileExtensionFilter;
...
public class AsyncBuildLibraryTask extends AsyncTask<String, String, Void> {
	 ...
	 * over to jelly' private database.
	 */
	private void saveMediaStoreDataToDB(Cursor mediaStoreCursor) {
		try {
    		...
    		//Iterate through MediaStore's cursor and save the fields to jelly' DB.
