 ...
 */
package com.jelly.music.player.SettingsActivity;
...
import com.jelly.music.player.AsyncTasks.AsyncGoogleMusicAuthenticationTask;
import com.jelly.music.player.BlacklistManagerActivity.BlacklistManagerActivity;
import com.jelly.music.player.Helpers.TypefaceHelper;
import com.jelly.music.player.Helpers.UIElementsHelper;
import com.jelly.music.player.InAppBilling.IabHelper;
import com.jelly.music.player.InAppBilling.IabResult;
import com.jelly.music.player.InAppBilling.Purchase;
import com.jelly.music.player.Services.AutoFetchAlbumArtService;
import com.jelly.music.player.Utils.Common;
import com.jelly.music.player.LauncherActivity.LauncherActivity;
...
public class SettingsActivity____ extends PreferenceActivity {
	...
	static final String ITEM_SKU = "com.jelly.music.player.unlock";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = this.getSharedPreferences("com.jelly.music.player", Context.MODE_PRIVATE);
...
/*    	bluetoothControlsPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
    	...
    	contactUsPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
			...
			public boolean onPreferenceClick(Preference arg0) {
				...
				Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto","jellymusicplayer@gmail.com", null));
				emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Jelly Music Player Support");
