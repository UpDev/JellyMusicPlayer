 ...
 */
package com.jelly.music.player.Helpers;
...
public class SongHelper {
    ...
    private int getIdColumnIndex() {
        if (mApp.getService().getCursor().getColumnIndex(MediaStore.Audio.Media.IS_MUSIC)==-1) {
            //We're dealing with jelly' internal DB schema.
            ...
            //Check if the current row is from jelly' internal DB schema or MediaStore.
