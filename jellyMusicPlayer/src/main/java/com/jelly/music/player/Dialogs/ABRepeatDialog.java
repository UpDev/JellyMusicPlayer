...
import com.jelly.music.player.Views.RangeSeekBar;
import com.jelly.music.player.Views.RangeSeekBar.OnRangeSeekBarChangeListener;
...
public class ABRepeatDialog extends DialogFragment {
	...
	public void onStart() {
	    ...
	    LocalBroadcastManager.getInstance(getActivity().getApplicationContext())
	    					 .registerReceiver((receiver), new IntentFilter("com.jelly.music.player.UPDATE_NOW_PLAYING"));
