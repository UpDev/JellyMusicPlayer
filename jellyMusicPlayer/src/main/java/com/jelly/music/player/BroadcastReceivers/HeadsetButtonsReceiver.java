 ...
 */
package com.jelly.music.player.BroadcastReceivers;
    	...
    	if (mApp.isServiceRunning()) {
			...
			if (keycode == KeyEvent.KEYCODE_MEDIA_NEXT) {
				...
				if (action == KeyEvent.ACTION_DOWN) {
					...
					nextIntent.setAction("com.jelly.music.player.NEXT_ACTION");
			...
			if (keycode == KeyEvent.KEYCODE_MEDIA_PREVIOUS) {
				...
				if (action == KeyEvent.ACTION_DOWN) {
					...
					previousIntent.setAction("com.jelly.music.player.PREVIOUS_ACTION");
